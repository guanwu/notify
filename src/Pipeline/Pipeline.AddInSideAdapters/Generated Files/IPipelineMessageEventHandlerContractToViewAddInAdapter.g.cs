...
namespace Guanwu.Notify.AddInSideAdapters
{
    ...
    public class IPipelineMessageEventHandlerContractToViewAddInAdapter
    {
        ...
        {
            _contract.EventHandler(Guanwu.Notify.AddInSideAdapters.PipelineMessageEventArgsAddInAdapter.ViewToContractAdapter(args));
        }
